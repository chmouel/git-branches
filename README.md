...
The colors are configurable via your git configuration (e.g., `git config --global color.branch.current green`).

### Branch & Commit Colors
...
| **PR Number**           | Grey                                | Color for the pull request number (`#1234`).                                |
| **Own PR Indicator**    | Yellow (`★`)                        | A star indicates a pull request that you have opened.                       |
| **Commit Type: `feat`** | Green                               | Indicates a new feature.                                                    |
| **Commit Type: `fix`**  | Red                                 | Indicates a bug fix.                                                        |
| **Commit Type: `docs`** | Cyan                                | Related to documentation changes.                                           |
| **Commit Type: `ref`**  | Magenta                             | Code refactoring without changing functionality.                            |
| **Commit Type: `test`** | Yellow                              | Test-related changes.                                                       |
| **Commit Type: `chore`**| Blue                                | Routine tasks, maintenance, or dependency updates.                          |

### Status Icons

| Icon | Name | Color | Description |
| :--- | :--- | :--- | :--- |
| `` | Open PR | Green | The pull request is open. |
| `` | Merged PR | Magenta | The pull request has been merged. |
| `` | Closed PR | Red | The pull request has been closed without merging. |
| `` | Draft PR | Yellow | The pull request is a draft. |
| `` | Pushed | Green | The local branch is pushed to the remote. |
| `` | Not Pushed | Red | The local branch does not exist on the remote. |
| `` | Unknown | Yellow | Could not determine the remote status of the branch. |
...
### CI Status Icons (GitHub Actions)

| Icon | Name | Color | Description |
| :--- | :--- | :--- | :--- |
| `` | Success | Green | All checks passed. |
| `` | Failed | Red | One or more checks failed. |
| `` | In Progress | Yellow | Checks are currently running. |
| `` | Cancelled | Red | The CI run was cancelled. |
| `` | Skipped | Cyan | The CI run was skipped. |
| `` | Unknown | Yellow | The status of the CI run is unknown. |

### Review Status Icons

| Icon | Name | Color | Description |
| :--- | :--- | :--- | :--- |
| `` | Approved | Green | The pull request has been approved. |
